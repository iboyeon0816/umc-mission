...
public class StoreRestController {
    ...
    public ApiResponse<MissionDetailListDTO> getMissions(@PathVariable @ExistStore Long storeId,
                                                         @PageCheck Integer page) {
        Page<Mission> missionPage = storeQueryService.getMissions(storeId, page);
        return ApiResponse.onSuccess(MissionConverter.toMissionDetailListDTO(missionPage));
    }
}
